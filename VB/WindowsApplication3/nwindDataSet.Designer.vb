...
Namespace DXSample
	...
	Partial Public Class nwindDataSet
		...
		Partial Public Class CustomersDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
			Public Function AddCustomersRow(ByVal CustomerID As String, ByVal CompanyName As String, ByVal ContactName As String, ByVal ContactTitle As String, ByVal City As String, ByVal Country As String) As CustomersRow
				Dim rowCustomersRow As CustomersRow = (CType(Me.NewRow(), CustomersRow))
				Dim columnValuesArray() As Object = { CustomerID, CompanyName, ContactName, ContactTitle, City, Country}
...
Namespace DXSample.nwindDataSetTableAdapters
	...
	Partial Public Class CustomersTableAdapter
		...
		Private Sub InitAdapter()
			...
			Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Customers` WHERE ((`CustomerID` = ?) AND ((? = 1 AND `CompanyName` IS NULL) OR (`CompanyName` = ?)) AND ((? = 1 AND `ContactName` IS NULL) OR (`ContactName` = ?)) AND ((? = 1 AND `ContactTitle` IS NULL) OR (`ContactTitle` = ?)) AND ((? = 1 AND `City` IS NULL) OR (`City` = ?)) AND ((? = 1 AND `Country` IS NULL) OR (`Country` = ?)))"
			...
			Me._adapter.InsertCommand.CommandText = "INSERT INTO `Customers` (`CustomerID`, `CompanyName`, `ContactName`, `ContactTitl" & "e`, `City`, `Country`) VALUES (?, ?, ?, ?, ?, ?)"
			...
			Me._adapter.UpdateCommand.CommandText = "UPDATE `Customers` SET `CustomerID` = ?, `CompanyName` = ?, `ContactName` = ?, `ContactTitle` = ?, `City` = ?, `Country` = ? WHERE ((`CustomerID` = ?) AND ((? = 1 AND `CompanyName` IS NULL) OR (`CompanyName` = ?)) AND ((? = 1 AND `ContactName` IS NULL) OR (`ContactName` = ?)) AND ((? = 1 AND `ContactTitle` IS NULL) OR (`ContactTitle` = ?)) AND ((? = 1 AND `City` IS NULL) OR (`City` = ?)) AND ((? = 1 AND `Country` IS NULL) OR (`Country` = ?)))"
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT CustomerID, CompanyName, ContactName, ContactTitle, City, Country FROM Cus" & "tomers"
		...
		Public Overridable Function Delete(ByVal Original_CustomerID As String, ByVal Original_CompanyName As String, ByVal Original_ContactName As String, ByVal Original_ContactTitle As String, ByVal Original_City As String, ByVal Original_Country As String) As Integer
			...
			Else
				...
				Me.Adapter.DeleteCommand.Parameters(10).Value = (CStr(Original_Country))
			End If
		...
		Public Overridable Function Insert(ByVal CustomerID As String, ByVal CompanyName As String, ByVal ContactName As String, ByVal ContactTitle As String, ByVal City As String, ByVal Country As String) As Integer
			...
			Else
				Me.Adapter.InsertCommand.Parameters(5).Value = (CStr(Country))
			End If
		...
		Public Overridable Function Update(ByVal CustomerID As String, ByVal CompanyName As String, ByVal ContactName As String, ByVal ContactTitle As String, ByVal City As String, ByVal Country As String, ByVal Original_CustomerID As String, ByVal Original_CompanyName As String, ByVal Original_ContactName As String, ByVal Original_ContactTitle As String, ByVal Original_City As String, ByVal Original_Country As String) As Integer
			If (CustomerID Is Nothing) Then
			...
			Else
				...
				Me.Adapter.UpdateCommand.Parameters(8).Value = (CStr(Original_CompanyName))
			End If
			If (Original_ContactName Is Nothing) Then
			...
			Else
				...
				Me.Adapter.UpdateCommand.Parameters(10).Value = (CStr(Original_ContactName))
			End If
			If (Original_ContactTitle Is Nothing) Then
			...
			Else
				...
				Me.Adapter.UpdateCommand.Parameters(12).Value = (CStr(Original_ContactTitle))
			End If
			If (Original_City Is Nothing) Then
			...
			Else
				...
				Me.Adapter.UpdateCommand.Parameters(16).Value = (CStr(Original_Country))
			End If
		...
		<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, True)> _
		Public Overridable Function Update(ByVal CompanyName As String, ByVal ContactName As String, ByVal ContactTitle As String, ByVal City As String, ByVal Country As String, ByVal Original_CustomerID As String, ByVal Original_CompanyName As String, ByVal Original_ContactName As String, ByVal Original_ContactTitle As String, ByVal Original_City As String, ByVal Original_Country As String) As Integer
