...
Namespace DXSample
	Partial Public Class Main
		...
		Private Function FindSubStringStartPosition(ByVal dispalyText As String, ByVal findText As String) As Integer
			...
			Return index
		End Function
		Private Function HiglightSubString(ByVal e As DevExpress.XtraGrid.Views.Base.RowCellCustomDrawEventArgs, ByVal findText As String) As Boolean
		...
		Private Sub OnCustomDrawCell(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Base.RowCellCustomDrawEventArgs) Handles gridView1.CustomDrawCell
			...
			If view.OptionsFind.HighlightFindResults AndAlso (Not view.FindFilterText.Equals(String.Empty)) Then
			 ...
			 If TypeOf op Is GroupOperator Then
				 ...
				 If HiglightSubString(e, findText) Then
				 e.Handled = True
				 End If
			 ElseIf TypeOf op Is FunctionOperator Then
				 ...
				 If (Not e.Column.FieldName.StartsWith(colName)) Then
					 Return
				 End If
